...
Of these, \reg{sp} is the only register that is not already marked as either caller- or callee-saved by the n64 ABI and becomes a temporary (caller-save) register in the \sandboxABI{}.
