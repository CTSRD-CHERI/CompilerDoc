...
\begin{table}
	\begin{center}
		\begin{tabu}{ll}
			...
			\ccode{__builtin_memcap_unsealed_get } & \asm{CGetUnsealed} \\
			...
			\ccode{__builtin_memcap_base_only_increment} & \asm{CIncBase2} \\
			\ccode{__builtin_memcap_program_counter_get} & \asm{CGetPCC} \\
			\ccode{__builtin_memcap_global_data_get} & \asm{CMove \%0, $v0} \\ %stopzone
			\midrule
