...
As before, each rounding direction comes with two options for specifying the alignment: either as a desired value or as the base-2 logarithm of the dsired value.
